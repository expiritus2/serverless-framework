...
var getAuctions_exports = {};
__export(getAuctions_exports, {
  handler: () => handler
});
...
var getAuctionsSchema_default = schema;

// src/functions/getAuctions/index.ts
var dynamoDB = new import_aws_sdk.default.DynamoDB.DocumentClient();
var getAuctions = async (event) => {
...
var handler = commonMiddleware_default(getAuctions).use((0, import_validator.default)({
  inputSchema: getAuctionsSchema_default,
  ajvOptions: {
    useDefaults: true,
    strict: false
  }
}));
module.exports = __toCommonJS(getAuctions_exports);
