...
var processAuctions_exports = {};
__export(processAuctions_exports, {
  handler: () => handler
});
...
var closeAuction = async (auction) => {
  const params = {
    TableName: process.env.AUCTIONS_TABLE_NAME,
    Key: { id: auction.id },
...
var processAuctions = async (event) => {
  try {
...
var handler = commonMiddleware_default(processAuctions);
module.exports = __toCommonJS(processAuctions_exports);
